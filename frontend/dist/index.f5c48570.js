...
document.addEventListener("DOMContentLoaded", function() {
    ...
    tileList.forEach(function(tile) {
        tile.addEventListener("click", function() {
            if (tile.style.backgroundColor == "lightblue") tile.style.backgroundColor = "white";
            else {
    ...
    document.getElementById("ticker-search").addEventListener("keyup", function(event) {
        if (event.keyCode == 13) searchTicker();
    });
});
...
function searchTickerCallback() {
    ...
    if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        new (0, _autoDefault.default)(tickerGraph, {
            type: "line",
            data: {
                labels: xValues,
                datasets: [
...
},{}]},["bcmUh","8ZNvh"], "8ZNvh", "parcelRequire30ab")
